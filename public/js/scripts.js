...
function onEmailInput(e) {
	...
	if(curEmailIndex > 0) {
		if(mouthStatus == "small") {
			mouthStatus = "medium";
			TweenMax.to([mouthBG, mouthOutline, mouthMaskPath], 1, { shapeIndex: 8, ease: Expo.easeOut});
		...
		if(value.includes("@")) {
			mouthStatus = "large";
			TweenMax.to([mouthBG, mouthOutline, mouthMaskPath], 1, { ease: Expo.easeOut});
		...
		mouthStatus = "small";
		TweenMax.to([mouthBG, mouthOutline, mouthMaskPath], 1, { shapeIndex: 9, ease: Expo.easeOut});
		TweenMax.to(tooth, 1, {x: 0, y: 0, ease: Expo.easeOut});
...
function coverEyes() {
	...
	TweenMax.to(bodyBG, .45, { ease: Quad.easeOut});
	eyesCovered = true;
}
