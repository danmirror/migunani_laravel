...
@section('content')
    ...
    <section class="container" id="foot">
        ...
        <div class="content  " >
            ...
            <form action="{{ url('/login/kirim') }}" method="post" class="my-5">
            {{ csrf_field() }}
                ...
                <div class="inputGroup inputGroup1">
                    <label for="loginEmail" id="loginEmailLabel" class="d-none">Email</label>
                    <input name="email" type="email" id="loginEmail" maxlength="254" />
                    <p class="helper helper1">Email</p>
                </div>
                <div class="inputGroup inputGroup2">
                    <label for="loginPassword" id="loginPasswordLabel" class="d-none">Password</label>
                    <input name="password" type="password" id="loginPassword" />
                    <p class="helper helper2">Password</p>
